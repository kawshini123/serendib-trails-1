...
// Chat Box එක විවෘත කිරීම සහ වැසීම
function toggleChat() {
  const chatBox = document.getElementById("ai-chat-box");
  chatBox.style.display = chatBox.style.display === "none" ? "block" : "none";
}

// Enter බොත්තම එබූ විට පණිවිඩය යැවීමට
...
// Gemini වෙත පණිවිඩය යැවීම සහ පිළිතුරු ලබා ගැනීම
async function sendToGemini() {
  ...
  // පාරිභෝගිකයාගේ පණිවිඩය චැට් එකට එකතු කිරීම
  ...
  const apiKey = "AQ.Ab8RN6Kj6DCr81hl3IztNVHvQnPYzCrWZD9WFu5NMEYxL3Tqeg"; // මෙතනට ඔබේ Google AI Studio API Key එක දාන්න
  ...
  try {
    ...
    // Loading ඉවත් කර AI ප්‍රතිචාරය පෙන්වීම
